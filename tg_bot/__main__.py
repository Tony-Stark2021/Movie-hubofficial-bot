...
ഹായ് {}, എന്റെ പേര് {}! ഞാൻ [ഇദ്ദേഹം](tg://user?id={}) നോക്കി നടത്തുന്ന ഒരു ബോട്ടാണ്.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                     ...
                     [InlineKeyboardButton(text="GROUP", url="https://t.me/mallu_movie_hub"), InlineKeyboardButton(text="CHANNEL", url="https://t.me/bcinemasinternanatianl")],
                     [InlineKeyboardButton(text="CONTACT OWNER", url="https://t.me/sagar_alias_jacky"), InlineKeyboardButton(text="🛠CONTACT SUPPORTER", url="https://t.me/cybersecurityhackerjinn)) ]]))
